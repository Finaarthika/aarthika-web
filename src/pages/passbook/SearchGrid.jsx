...
const StaffHeader = () => (
  <div className="bg-gradient-to-r from-aarthikaDark to-aarthikaBlue py-4 px-6 shadow-lg mb-8 rounded-b-2xl mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-between border-b-4 border-aarthikaBlue/50 relative overflow-hidden">
    ...
    <div className="flex items-center z-10">
      <div className="bg-white rounded-full w-12 h-12 mr-4 shadow-xl flex-shrink-0 overflow-hidden flex items-center justify-center p-1 border-2 border-white/20">
        <img src={logoIcon} alt="Aarthika Icon" className="h-full w-full object-cover rounded-full" />
      </div>
      <div className="flex flex-col">
        <img src={logoTextUrl} alt="Aarthika" className="h-7 object-contain origin-left" style={{ filter: 'brightness(0) invert(1)' }} />
        <span className="text-blue-200 text-[10px] sm:text-xs font-bold tracking-widest uppercase mt-1">Core Banking • Staff Portal</span>
      </div>
    </div>
    <div className="hidden sm:block z-10 text-right">
      <div className="text-white/60 text-xs font-medium">Secured Terminal</div>
        ...
        <div className="premium-container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight flex items-center gap-2">
              <svg className="w-6 h-6 text-aarthikaBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
              Customer Directory
            </h1>
    ...
    return (
      <div className="bg-gray-50 min-h-screen pb-10 font-sans">
        ...
        <div className="premium-container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight flex items-center gap-2">
              <svg className="w-6 h-6 text-aarthikaBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" /></svg>
              Account Origination
            </h1>
            <button onClick={() => setView('SEARCH')} className="text-gray-500 hover:text-gray-800 flex items-center gap-2 font-semibold transition-colors bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
    ...
    <div className="bg-gray-50 min-h-screen pb-10 font-sans">
      ...
      <div className="premium-container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-gray-800 tracking-tight flex items-center gap-2">
            <svg className="w-6 h-6 text-aarthikaBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" /></svg>
            Account Ledger
          </h1>
          <button onClick={() => setView('SEARCH')} className="text-gray-500 hover:text-gray-800 flex items-center gap-2 font-semibold transition-colors bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
